...
public class MonsterSpawner14 : MonoBehaviour
{
    public GameObject enemyPrefab;
    public List<SpawnArea> spawnAreas;
    public EnemyMAXspawn14 enemyManager;
    ...
    void SpawnEnemy(SpawnArea spawnArea)
    {
        ...
        enemy.AddComponent<EnemyController14>().Initialize(enemyManager);
...
{
    private EnemyMAXspawn14 enemyManager;

    public void Initialize(EnemyMAXspawn14 manager)
    {
